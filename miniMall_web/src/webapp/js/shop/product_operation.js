$(function() {
    ...
    var infoUrl = '/shop_admin/get_product?productId=' + productId;
    // 获取当前店铺设定的商品类别列表的URL
    var categoryUrl = '/shop_admin/product_category_list';
    // 更新商品信息的URL
    var productPostUrl = '/shop_admin/modification_product';
    // 由于商品添加和编辑使用的是同一个页面，
    // 该标识符用来标明本次是添加还是编辑操作
    var isEdit = false;
    if (productId) {
        ...
        getCategory();
        productPostUrl = '/shop_admin/add_product';
    }
