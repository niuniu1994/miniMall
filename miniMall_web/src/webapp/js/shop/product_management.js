$(function () {
    let pageNum = 1;
    // 获取此店铺下的商品列表的URL
    var listUrl = '/shop_admin/product_list';
    // 商品下架URL
    var statusUrl = '/shop_admin/modification_product';
    getList();
    ...
    function getList() {
        ...
        $.ajax({
                ...
                success: function (data) {
                    var productList = data.productList.list;
                    var tempHtml = '';
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/shop_admin/product_operation?productId='
                    ...
                    window.location.href = '/frontend/product_detail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
